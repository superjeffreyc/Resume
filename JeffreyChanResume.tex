...
\textbf{SKILLS} \\ [-10.5pt]
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.4pt}}\\
{\it Languages}~: Python, C++, C, JavaScript, HTML, CSS, Java, Ruby, x86 Assembler, IBM Assembler \\
{\it Operating Systems}~: Windows, Linux, z/VM \\
{\it Tools}~: Bash, Vim, Git, Cygwin, Django, Travis CI, Visual Studio, Android Studio, Cloud9 IDE, Heroku, PostgreSQL \\
